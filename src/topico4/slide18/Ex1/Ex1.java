...
/**
 * Faca um programa em Java que use Threads para encontrar os nuumeros primos
 * dentro de um intervalo. O metodo que contabiliza os numeros primos deve
 * possuir como entrada: valor inicial e final do intervalo, numero de threads.
 *
 * @author itsgnegrao
 */
